    ...
    <div className="nav-container">
      <div className="nav">
        <div className="nav-items">
          <Link to="/" style={{ color: "#252b42", textDecoration: "none" }}>
            <div className="nav-header">AccioJob</div>
          </Link>
          <div className="nav-item-list left">
            <ul>
              <li>
                <Link
                  to="/"
        ...
        <div className="nav-items">
          <div className="nav-item-list right">
            <ul>
              <li>
                <Link
                  to="/profile"
              ...
              <li>
              <Link to="/supportUs" style={{color: '#737373', textDecoration: 'none' }}>
                <svg
                  width="16"
                  height="15"
                  viewBox="0 0 16 15"
